...
class MediaPageScreen extends StatelessWidget {
  ...
  final Map<MediaSection, GlobalKey> _keys = {
    MediaSection.events: GlobalKey(),
    MediaSection.newsletters: GlobalKey(),
    MediaSection.gallery: GlobalKey(),
    MediaSection.blogs: GlobalKey(),
               ...
               Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            key:_keys[MediaSection.newsletters],
                        ...
                        Container(
                          key:_keys[MediaSection.gallery],
