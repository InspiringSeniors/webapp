...
import 'package:inspiringseniorswebapp/modules/fun_with_art_screen/controller/fwa_controller.dart';
...
class FunWithArtBindings extends Bindings{
  @override
  void dependencies() {
    Get.put(FunWithArtController());
  }
}