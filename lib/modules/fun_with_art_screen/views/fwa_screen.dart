    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Image.network("https://firebasestorage.googleapis.com/v0/b/inspiringseniorswebapp.firebasestorage.app/o/posters%2Ffuntherapy.jpeg?alt=media&token=02089440-3ff3-456c-a027-f54ef378f372",fit: BoxFit.cover,),
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: CachedNetworkImage(imageUrl: "https://firebasestorage.googleapis.com/v0/b/inspiringseniorswebapp.firebasestorage.app/o/posters%2Ffuntherapy.jpeg?alt=media&token=02089440-3ff3-456c-a027-f54ef378f372",fit: BoxFit.cover,),
                            ...
                            Expanded(
                              child: Container(
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    SelectableText(" Fun therapy with Art ",style: TextStyleUtils.heading3,),
                                    SizedBox(height: 20,),
                                    SelectableText(
                                      "Fun Therapy with Art is a joyful space within ISF's Learning Studio, designed for seniors to unleash their creativity, embrace lifelong learning, and rediscover the beauty of self-expression. Here, art becomes more than just a hobby—it’s a therapeutic journey where your hands, heart, and imagination come together to create pieces that stimulate both the mind and emotions. Whether you're exploring new techniques or simply enjoying the process, you’ll find that every emotion has a color, and every color tells a unique story.\n\nCheck our Inspiring Seniors Art Gallery to Admire and get inspired by beautiful paintings created by our membersJoin us to relax, express, and find fulfillment in every brushstroke on this fun and inspiring artistic adventure!"
          ...
          // Vertical button on the right side
          Positioned(
