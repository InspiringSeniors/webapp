          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                isMobile?
                Container(
                  padding: EdgeInsets.symmetric(vertical: TextSizeDynamicUtils.dHeight28,horizontal: 24),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Image.network("https://firebasestorage.googleapis.com/v0/b/inspiringseniorswebapp.firebasestorage.app/o/posters%2Fmeloday_masters_main.jpeg?alt=media&token=8884df29-96db-40dd-a528-3f14723906f6",fit: BoxFit.cover,),
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: CachedNetworkImage(imageUrl: "https://firebasestorage.googleapis.com/v0/b/inspiringseniorswebapp.firebasestorage.app/o/posters%2Fmeloday_masters_main.jpeg?alt=media&token=8884df29-96db-40dd-a528-3f14723906f6",fit: BoxFit.fill,),
                            ...
                            Expanded(
                              child: Container(
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    SelectableText("Melody Masters ",style: TextStyleUtils.heading3,),
                                    SizedBox(height: 20,),
                                    SelectableText(
                                      "Melody Masters is a vibrant community of senior music enthusiasts who come together to celebrate the joy of music, connection, and self-expression. From sharing daily songs based on fun musical themes to joining our live weekly meet-up alternate Thursday from 4 to 5 PM, this is a space where voices shine and hearts sing in harmony. Whether you love retro hits, timeless classics, or karaoke fun, there’s a place for everyone to participate, connect, and create lasting friendships through music. Join us in this melodious journey where every note brings us closer together!."
