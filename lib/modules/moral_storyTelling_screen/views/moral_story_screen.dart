...
class MoralStoryScreen extends StatelessWidget {
  MoralStoryController moralStoryController =Get.find();
                ...
                if (isMobile) Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Moral StoryTelling - Aao Kahani Sunein",style: TextStyleUtils.heading2,),
                      SizedBox(height: TextSizeDynamicUtils.dHeight28,),
                      Container(

                        child: CachedNetworkImage(imageUrl: "https://firebasestorage.googleapis.com/v0/b/inspiringseniorswebapp.firebasestorage.app/o/posters%2Fbook_club.jpeg?alt=media&token=4ca8a1dd-1f42-400f-9de4-396ddb88577f",fit: BoxFit.cover,),
                      ...
                      Text("Because some values are best passed down through stories..."
                          ,style: TextStyleUtils.mobileheading3),
                      SizedBox(height: 10,),
                      Text(
                        "Storytelling is a bridge that connects generations, nurtures empathy, and shapes young minds with timeless values.‘Aao Kahani Sunein’ is a heartwarming weekly initiative in collaboration with Vridhcare where senior volunteers from ISF narrate moral-based stories online to children living in orphanages."
                        ,style: TextStyleUtils.phoneparagraphSmall,),
                      SizedBox(height: 10,),


                      Text("Through this initiative:\n\n - Children experience connections through stories that instill moral values.\n\n - Senior citizens find purpose and joy by sharing their wisdom in meaningful ways with the next generation.\n\n - Weekly sessions become a space for learning, bonding, and emotional growth\n\nIf you're 50+ and have stories to share, or just the heart to read them aloud, we’d love to welcome you.",style: TextStyleUtils.paragraphSmall,),
                      ...
                      Container(
                        child: Column(
                          children: [
                            ...
                            CustomCarousel(carouselList: moralStoryController.onboardingList,currentPageNotifier:  _currentPageNotifier,viewportsection: 1,),
                            SizedBox(height: TextSizeDynamicUtils.dHeight56,),
                            FAQSection(faqList: moralStoryController.faqList.value)
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: CachedNetworkImage(imageUrl: "https://firebasestorage.googleapis.com/v0/b/inspiringseniorswebapp.firebasestorage.app/o/posters%2Fbook_club.jpeg?alt=media&token=4ca8a1dd-1f42-400f-9de4-396ddb88577f",fit: BoxFit.fill,),
                            ...
                            Expanded(
                              child: Container(
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    SelectableText("Moral StoryTelling - Aao Kahani Sunein",style: TextStyleUtils.heading3,),
                                    SizedBox(height: 20,),
                                    SelectableText(
                                        "Because some values are best passed down through stories..."
                                    ...
                                    SelectableText("Through this initiative:\n\n - Children experience connections through stories that instill moral values.\n\n - Senior citizens find purpose and joy by sharing their wisdom in meaningful ways with the next generation.\n\n - Weekly sessions become a space for learning, bonding, and emotional growth\n\nIf you're 50+ and have stories to share, or just the heart to read them aloud, we’d love to welcome you.",style: TextStyleUtils.paragraphSmall,),
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(
                                ...
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Container(child: Text("Our Moral StoryTellers and Young Children",style: TextStyleUtils.heading3,),),
                                  SizedBox(height: 64,),

                                  CustomCarouselWithArrows(list: moralStoryController.onboardingList,),
                                ],
                              ),
                            ),
                            ...
                            Container(
                              // color: ColorUtils.BACKGROUND_COLOR,
                                ...
                                child: Container(
                                    ...
                                    child: FAQSection(faqList: moralStoryController.faqList.value))
                            ),
